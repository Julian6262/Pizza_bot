...
from keyboards.keyboards import get_user_main_btns, get_user_catalog_btns, get_products_btns, get_user_cart
...
async def products(session, level, category, page):
    ...
    kbds = get_products_btns(level=level, category=category, page=page, pagination_btns=pagination_btns,
